...
<html>
    ...
    <body>
        <div class="row">
            ...
            <div class="col-md-8">
                <form action="../../subirimagen" method="POST" enctype="multipart/form-data" style="margin-top: 23px;">
                    <table>
                        <tr>
                                <label>Imagen de Portada</label>
                                <p>Recomendacion Subir Imagen de (1360x300) pixeles </p>
                            <td>
                                <input type="file" name="nosotros1" size="30" >
                            </td>
                            <br>
                            <td>      
                ...
                <form action="../../subirimagen" method="POST" enctype="multipart/form-data" >
                    <table>
                        <tr>
                                <label>Foto de Mision</label>
                            <td>
                                <input type="file" name="nosotros2" size="30" >
                            </td>
                            <br>
                            <td>      
                                <input type="submit" class="btn btn-primary" value="Guardar" style="margin-left: 22px;">
                ...
                <form action="../../subirimagen" method="POST" enctype="multipart/form-data" >
                    <table>
                        <tr>
                                <label>Foto de Vision</label>
                            <td>
                                <input type="file" name="nosotros3" size="30" >
                            </td>
                            <br>
                            <td>      
                                <input type="submit" class="btn btn-primary" value="Guardar" style="margin-left: 22px;">
                ...
                <form action="../../subirimagen" method="POST" enctype="multipart/form-data" >
                    <table>
                        <tr>
                                <label>Foto de Ubicacion</label>
                            <td>
                                <input type="file" name="nosotros4" size="30" >
                            </td>
                            <br>
                            <td>      
                                <input type="submit" class="btn btn-primary" value="Guardar" style="margin-left: 22px;">
            ...
            <div class="row">
                 ...
                 <% } 
                HRService dd = new HRService();
                for(ContenidoWeb web: dd.MostrarNosotros("UBICACION","lizardo2016")){ %>
            <div class="row">
                    <h1>Vision</h1>
                    <form method="POST" action="../../updateno">
                    <textarea style="margin: 0px; width: 826px; height: 94px;" name="mision"><%=web.getContenido()%></textarea>
