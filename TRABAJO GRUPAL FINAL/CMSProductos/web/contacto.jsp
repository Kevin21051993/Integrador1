        ...
        <main>
            <section>
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <form name="formcontactenos" method="post" action="email">
                                <div class="form-group">
                                  <input type="text" name="nombres_apellidos" class="form-control"  placeholder="Nombres y Apellidos" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                     <textarea rows="8" type="text" name="comentarios" class="form-control" required  placeholder="Comentario o Mensaje..."></textarea>
                                </div>                   
                                <button type="submit" style="margin-left:88%;" class="btn btn-default">Enviar</button>
                            </form>
                        </div>
                                    <% HRService hr = new HRService();
                for(ContenidoWeb web: hr.MostrarNosotros("FCONTACTO","lizardo2016")){ %>
            <div class="col-md-5">
                <img src="recursos/imagenes/contacto/<%=web.getContenido()%>" class="img-responsive" alt="Responsive image" >
            </div>
             <% }%>
                    </div>
                </div>
                    ...
                    <div class="container-fluid container-semi-fluid footer-container">     
                        <div class="footer-nav-follow-us-row row">
                            ...
                            <div class="col-md-3 col-sm-12 footer-follow-us-block footer-left-border">
                                ...
                                <div class="col-xs-12 text text-sans-serif text-light-sans-serif footer-copyright">&copy; 2016 Tienda Virtual - UTP | Todos los derechos reservados. </div>
                             </div>
                    </div>
                    </div>
                 </div>
