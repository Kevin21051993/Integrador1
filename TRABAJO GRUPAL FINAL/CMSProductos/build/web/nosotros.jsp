    ...
    <body>
        ...
        <main>
           <!--<p>Bienvenido ${sessionScope.user}</p>-->
            ...
            <div class="row">
                <img src="recursos/imagenes/nosotros/<%=web.getContenido()%>" class="img-responsive" alt="Responsive image" style="margin-top:-21px;">
            </div>
             <% }
            ...
            <div class="container">
                <div class="panel panel-default" style="margin-top: 18px;">
                    <div class="panel-body">
                        <div class="row">
                            <% HRService hj = new HRService();
                for(ContenidoWeb w: hj.MostrarNosotros("FMISION","lizardo2016")){ %>
                            <div class="col-md-4">
                                <img src="recursos/imagenes/nosotros/<%=w.getContenido()%>" class="img-responsive" alt="Responsive image">
                            </div>
                            <% } %>
                            <div class="col-md-8">
                                <h1>Mision</h1>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">   
                        <div class="row">
                            ...
                            <% HRService hgj = new HRService();
                for(ContenidoWeb wy: hgj.MostrarNosotros("FVISION","lizardo2016")){ %>
                            <div class="col-md-4">
                                <img src="recursos/imagenes/nosotros/<%=wy.getContenido()%>" class="img-responsive" alt="Responsive image">
                            </div>
                            <% } %>
                        </div>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="row">
                            <% HRService htj = new HRService();
                for(ContenidoWeb wi: htj.MostrarNosotros("FUBICANOS","lizardo2016")){ %>
                            <div class="col-md-4">
                                <h1>Ubicanos en..</h1>
                                <img src="recursos/imagenes/nosotros/<%=wi.getContenido()%>" class="img-responsive" alt="Responsive image">
                            </div>
                            <% } %>
                            <div class="col-md-8">
                                 <%=web.getContenido()%>
