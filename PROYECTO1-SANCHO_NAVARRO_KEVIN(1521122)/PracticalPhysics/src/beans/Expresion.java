...
public class Expresion {
    ...
    public Expresion(String c) throws Exception {
        cadenaFuncion = c;
    }
 
    public void generarTokens() throws Exception {
        ...
        while(entrada.length()>0) {
            ...
            if(entrada.charAt(0) == 't' || entrada.charAt(0) == 'T') {
                colaTokens.add(new Token(TipoToken.VARIABLE,"t"));
            ...
            throw new Exception("Elemento no reconocido en la entrada: " + entrada.charAt(0));
        }
    }
        ...
        try {
            ...
            switch(token.tipo) {
                ...
                case FUNCION:   leaToken(TipoToken.P_IZQ);
                                ...
                                leaToken(TipoToken.P_DER);
                                Method m = java.lang.Math.class.getMethod(token.texto, Double.TYPE);
